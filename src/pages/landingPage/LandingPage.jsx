...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-[#2e2e2e] flex flex-col items-center pt-[8vh] pb-[2vh] md:py-0 relative z-[1]">
        <div>
          ...
          <div className="relative">
            ...
            />
            <h2 className="static md:absolute bottom-0 right-0 text-[5vw] sm:text-[4.5vw] md:text-[1.11vw] m-0 p-[0.37vw] md:bg-[#2e2e2e] mt-2 md:mt-0 text-center md:text-left">
      ...
      <div className="bg-gradient-to-b from-black/0 to-[#1f1f1f] h-auto md:h-[30%] z-[20] py-12 md:py-0 relative">
        <div className="mb-4">
          <ShiftingButton
