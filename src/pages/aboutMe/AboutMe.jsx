...
export default function AboutMe() {
  return (
    <section className="h-auto bg-white text-black pb-20">
      ...
      <div className="flex justify-center md:justify-start overflow-hidden bg-[#050505]">
        <motion.div
          initial={{ y: "100%" }}
          whileInView={{ y: 0 }}
      ...
      >
        Hi there! I’m <b className="font-bold text-[#1f1f1f]">Lieu Rik</b>, an aspiring full stack developer.
      </motion.p>
    </section>
  );
}
