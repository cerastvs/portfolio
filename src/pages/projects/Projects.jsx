...
export default function Projects() {
  return (
    <section className="bg-[#e6e6e6] text-black relative w-full overflow-hidden flex flex-col justify-start min-h-screen">
      ...
      <div className="relative z-10 px-6 md:px-[20%] mt-8 md:mt-12">
        <motion.p
          initial={{ y: 30, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.6 }}
          className="text-[14px] md:text-[16px] leading-relaxed max-w-4xl text-left md:text-center text-[#333] font-medium mx-auto"
        >
      ...
      <div className="relative w-full max-w-6xl mx-auto mt-20 pb-40 flex justify-center min-h-[800px]">
        <div className="absolute inset-y-0 flex justify-center z-0 left-0 right-0 w-full h-full">
          <img
            src={projectsTree}
            className="h-[100%] md:h-auto md:w-auto max-w-full object-contain object-bottom"
            alt="Projects Tree"
          />
        </div>
        ...
        <div className="md:hidden relative z-10 w-full px-6 flex flex-col space-y-6 mt-32"></div>
      </div>
